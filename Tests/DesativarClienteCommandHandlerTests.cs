...
namespace Tests
{
    public class DesativarClienteCommandHandlerTests : IDisposable
    {
        private readonly ISessionFactory _sessionFactory;
        private readonly ISession _session;
        private readonly IClienteRepositorio _repositorio;
        private readonly DesativarClienteCommandHandler _manipulador;

        public DesativarClienteCommandHandlerTests()
        {
            _sessionFactory = TestNHibernateConfig.CriarSessionFactory();
            _session = _sessionFactory.OpenSession();
            _repositorio = new NHibernateClienteRepositorio(_session);
            _manipulador = new DesativarClienteCommandHandler(_repositorio);
        }
        ...
        public async Task Handle_DeveDesativarClienteComSucesso_QuandoClienteEstaAtivo()
        {
            ...
            var comando = new DesativarClienteCommand(cliente.Id);
        ...
        public async Task Handle_DeveRetornarNull_QuandoClienteNaoExiste()
        {
            ...
            var comando = new DesativarClienteCommand(idInexistente);
        ...
        public async Task Handle_DeveDesativarApenasClienteEspecifico_QuandoExistemMultiplosClientes()
        {
            ...
            var comando = new DesativarClienteCommand(cliente1.Id);
